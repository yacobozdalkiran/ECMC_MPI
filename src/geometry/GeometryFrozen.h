...
//Geometry of a lattice with non periodic BC
...
public:
    ...
    //Index function for is_frozen_flat
...
namespace mpi {
    //GeometryFrozen with index halo functions and square lattice
    class GeometryFrozenMPI {
    public:
        int L;
        size_t V;
    private:
    ...
    public:
        explicit GeometryFrozenMPI(int L);
        ...
        //Index function for local coordinates x,y,z of halo send/recv
        [[nodiscard]] size_t index_halo(int x, int y, int z) const {
