...
namespace mpi::ecmccb {
    ...
    std::vector<double> samples_improved(GaugeField &field, const GeometryCB &geo, const ECMCParams &params, std::mt19937_64 &rng, HaloObs &halo_obs, mpi::MpiTopology &topo);
}
