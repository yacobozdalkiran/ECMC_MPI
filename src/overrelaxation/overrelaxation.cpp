...
void overrelaxation::hit(GaugeField& field, const GeometryCB& geo, size_t site, int mu, SU3& A) {
...
void overrelaxation::sweep(GaugeField& field, const GeometryCB& geo) {
    SU3 A;
...
void mpi::overrelaxationcb::hit(GaugeField& field, const GeometryCB& geo, size_t site, int mu,
                                SU3& A) {
    field.compute_staple(geo, site, mu, A);
...
void mpi::overrelaxationcb::sweep(GaugeField& field, const GeometryCB& geo,
...
// Runs a ov sweep using checkerboard updates
void mpi::overrelaxationcb::full_sweep(GaugeField& field, const GeometryCB& geo, int N_hits) {
